...
inner join dbo.tsysAssetTypes as t on a.AssetType = t.AssetType
where not exists 
( select c.AssetId from dbo.rAsset as c where c.AssetId = ac.AssetID)
