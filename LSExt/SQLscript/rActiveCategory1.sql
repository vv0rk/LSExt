...
if OBJECT_ID (N'rActiveCategory1') is null
	begin;
		...
		(
			...
			[nrInv] nvarchar(50) null,			-- инвентарный є
			[nrNom] nvarchar(50) null,			-- номенклатурный є
			[Number] int not null default 1,	-- количество 
			/* Ёти пол€ нужны дл€ контрол€ */
			[nomName] nvarchar(255) null,		-- им€ номенклатуры из прихода
			[nrAccount] nvarchar(20) null,		-- счет учета
			[Company] nvarchar(50) null,		-- организаци€ пользователь
			[Gorod] nvarchar(50) null,			-- √ород
			[Address] nvarchar(255) null,		-- јдрес
			[Office] nvarchar(100) null,		-- ѕомещение
			[User] nvarchar(100) null,			-- ‘»ќ пользовател€
